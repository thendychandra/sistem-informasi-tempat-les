...
<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">         <span class="sr-only">Toggle navigation</span>
  ...
  <a class="navbar-brand" href="home">ATHENA STUDY CENTRE</a>
  </div>
...
<?php
	if (isset($_SESSION['pb'])) {
			...
			$link=array("","add_siswa","add_pb","siswa","absen","absensi","req_catatan","catatan","add_schedule","katasandi&id=$_SESSION[id]","keluar");
			$name=array("","Tambah Siswa","Tambah Pengajar","Daftar Siswa","Absen","Lihat Absensi","Catatan","Lihat Catatan","Jadwal Les","Ubah Katasandi","Keluar");
